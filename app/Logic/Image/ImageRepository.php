...
class ImageRepository
{
    ...
    {
        $validator = Validator::make($form_data, ImageModel::$rules, ImageModel::$messages);
        if ($validator->fails()) {
        ...
        if( !$uploadSuccess1 || !$uploadSuccess2 ) {
            return Response::json([
                'error' => true,
                'message' => 'Server error while uploading ' . $filename . " " . $allowed_filename,
                'code' => 500
            ], 500);
        }
        $sessionImage = new ImageModel;
